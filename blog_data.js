...
// blogObjectFactory(TITLE, AUTHOR, ENTRY, TAGS)
let Blog2 = blogObjectFactory("First Group Project", "Tyler Bowman", "blah blah blah", "project", "NSS", "Comapny website", "group")

blogArchive.push(Blog1, Blog2);
